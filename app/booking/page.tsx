            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  ...
                  { num: '03', title: 'Првична консултација', desc: 'Средба од 60-90 минути каде што ќе разговараме за вашата исхрана, здравствени цели и ќе креираме персонализиран план.', color: 'from-green-400 to-green-600' },
