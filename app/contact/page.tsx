          ...
          <div className="container-custom">
            <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="group relative overflow-hidden bg-gradient-to-br from-primary/10 to-green-50/50 border-2 border-primary/20 rounded-2xl p-8 text-center hover:shadow-soft-xl transition-all duration-500 hover:scale-[1.02]">
                ...
                <h3 className="font-serif text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Емаил</h3>
                <a
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-br from-primary/10 to-emerald-50 border-2 border-primary/20 rounded-2xl p-6">
                  ...
                  <p className="text-text-secondary">
                    Работам од понеделник до петок, 09:00-17:00. Викенд термини се
                    достапни по договор.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-green-100 border-2 border-emerald-200 rounded-2xl p-6">
                  ...
                  <p className="text-text-secondary">
                    Добро е да имате список на лекови кои ги земате и резултати од скорешни крвни анализи (ако имате).
                  </p>
                </div>
