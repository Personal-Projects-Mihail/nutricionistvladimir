            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-3 p-4 bg-primary/10 dark:bg-primary/20 rounded-xl border border-primary/20">
                  ...
                  <div>
                    <p className="font-semibold text-text mb-1">Online Consultations by Your Preference</p>
                    <p className="text-sm text-text-secondary">Consultations are conducted online via Google Meet, Viber, WhatsApp, or another platform of your choice.</p>
                  </div>
                </div>
              </div>
