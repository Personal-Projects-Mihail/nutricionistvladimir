...
export const metadata: Metadata = generateMetadata('en', {
  title: 'Book Consultation | Нутриционист Владимир',
  description:
    'Закажете вашата прва консултација за исхрана со регистриран нутриционист Владимир. Онлајн и лично достапно низ Македонија.',
  path: '/booking',
  keywords: [
    'закажи консултација',
    'термин',
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8">
                {[
                  ...
                  { num: '03', title: 'Initial Consultation', desc: 'Средба од 60-90 минути каде што ќе разговараме за вашата исхрана, здравствени цели и ќе креираме персонализиран план.', color: 'from-green-400 to-green-600' },
          ...
          <div className="container-custom">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="space-y-4">
                {[
                  { q: 'Колку трае првичната консултација?', a: 'Првичната консултација обично трае 60-90 минути. Ова ни дава доволно време за детален преглед на вашата исхрана, здравствена историја и креирање на персонализиран план.' },
