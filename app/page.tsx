            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pt-4">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link href="/booking" className="group relative overflow-hidden bg-text dark:bg-[#1A1A1A] hover:bg-text/90 dark:hover:bg-[#1A1A1A]/90 text-white font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 flex items-center justify-center gap-2">
                    <span>Закажи консултација</span>
                    <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                    </svg>
                  </Link>
                  <Link href="/about" className="border-2 border-text dark:border-[#1A1A1A] text-text dark:text-[#1A1A1A] hover:bg-text dark:hover:bg-[#1A1A1A] hover:text-white font-semibold text-lg px-8 py-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-2">
                    Запознај ме
                  </Link>
                </div>
              </div>
