...
export const metadata: Metadata = {
  title: 'Ценовник | Владимир - Дипломиран Нутриционист',
  description: 'Изберете го пакетот што ви одговара. Персонализирани планови за исхрана, online консултации и секојдневна поддршка за постигнување на вашите здравствени цели.',
  openGraph: {
    title: 'Ценовник | Владимир - Дипломиран Нутриционист',
    description: 'Изберете го пакетот што ви одговара. Персонализирани планови за исхрана, online консултации и секојдневна поддршка.',
  },
};
  ...
  const pricingPlans = [
    {
      ...
      features: [
        ...
        '2 online консултации (30 минути)',
        'Секојдневна online поддршка',
      ],
      popular: false,
    ...
    },
    {
      ...
      features: [
        'Персонализиран план за исхрана',
        '7 online консултации (30 минути)',
        'Секојдневна online поддршка',
        'Дополнителен прирачник со рецепти',
      ],
      popular: true,
    ...
    },
    {
      ...
      features: [
        'Персонализиран план за исхрана',
        '15 online консултации (30 минути)',
        'Секојдневна online поддршка',
        'Дополнителен прирачник со рецепти',
      ],
      popular: false,
          ...
          <div className="container-custom relative z-10 py-12 text-center">
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-text-secondary max-w-2xl mx-auto">
                Секој пакет е дизајниран да ви обезбеди персонализирана поддршка на вашето патување кон подобро здравје
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container-custom relative z-10">
                  ...
                  <div className={`relative flex flex-col h-full w-full p-8 rounded-3xl bg-white/80 dark:bg-background-secondary/80 backdrop-blur-xl shadow-soft-lg ring-1 ring-primary/10 ${plan.borderGlow} transition-all duration-500`}>
                    ...
                    <div className="text-center mb-8 pb-8 border-b border-border">
                      <div className="flex items-end justify-center gap-2 mb-2">
                        ...
                        <span className="text-text-secondary text-lg mb-2">денари</span>
                      </div>
                      <p className="text-sm text-text-secondary">
                        {plan.pricePerMonth} ден. / месечно
                      </p>
                    </div>
            ...
            <div className="mt-16 text-center">
              <p className="text-text-secondary max-w-2xl mx-auto">
                <span className="font-semibold text-text">Потребна ви е помош со изборот?</span>{' '}
                Контактирајте ме за бесплатна консултација и заедно ќе го најдеме најдобриот пакет за вас.
              </p>
              <Link
                href="/contact"
