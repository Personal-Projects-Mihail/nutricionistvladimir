          ...
          <div className="container-custom">
            ...
            <div className="relative w-full min-h-[600px] md:min-h-[700px] py-8">
              ...
              {[
                ...
                { num: '03', title: 'Редовни Follow-ups', desc: 'Следење на напредокот, приспособување на планот и решавање на предизвици. Обично на секои 2-4 недели.', color: 'from-green-400 to-green-600', left: '40%', top: '300px' },
                { num: '04', title: 'Континуирана Поддршка', desc: 'Email поддршка меѓу консултациите за прашања и мотивација во текот на целиот процес.', color: 'from-teal-400 to-teal-600', left: '60%', top: '450px' }
              ].map((step, idx) => (
                <div
                  key={idx}
