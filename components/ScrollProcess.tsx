...
const steps: ProcessStep[] = [
  {
    num: '1',
    title: 'Закажи консултација со Владимир',
    desc: 'Одбери термин и испрати барање',
    icon: (
  ...
  {
    num: '3',
    title: 'Добиј персонализиран план',
    desc: 'Персонализиран план за твоите цели и потреби',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    num: '4',
    title: 'Имплементирај и следи напредок',
    desc: 'Започни го планот со наша континуирана поддршка и следење на резултатите',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    num: '5',
    title: 'Постигни долгорочен успех',
    desc: 'Оствари ги целите и гради одржливи навики за цел живот',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-text mb-4">
            Вашиот пат до поздраво тело
          </h2>
          <p className="text-xl text-text-secondary max-w-2xl mx-auto">
            Едноставен и здрав начин за постигнување на вашите цели
          </p>
        </div>
